...
export const openWeatherApiToken =
  process.env.REACT_APP_OPEN_WEATHER_API_TOKEN ||
  process.env.OPEN_WEATHER_API_TOKEN;
export const firebaseApiKey =
  process.env.REACT_APP_FIREBASE_API_KEY || process.env.FIREBASE_API_KEY;
export const firebaseAppId =
  process.env.REACT_APP_FIREBASE_APP_ID || process.env.FIREBASE_APP_ID;
