const bakaRootRoute = "https://wigym.cz/";

export const bakaSuffix = ".htm";

export const bakaSuplRoute = bakaRootRoute + "suplovani/tr";
export const bakaPlanRoute = bakaRootRoute + "plan/pt";
